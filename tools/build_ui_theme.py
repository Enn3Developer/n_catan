...
for typ in ['Button','OptionButton','CheckButton','CheckBox']:
 ...
 for state,style in [('normal','button'),('hover','button-hover'),('pressed','button-pressed'),('disabled','button-disabled'),('focus','Focus')]:prop(f'{typ}/styles/{state}',f'SubResource("{style}")')
