...
const SECTIONS=[
	...
	["Saved games","The host's game saves about once a second, and again when the host leaves. In the lobby, Resume saved game picks it up. Friends rejoin with the new invite and get their seats back by name."],
