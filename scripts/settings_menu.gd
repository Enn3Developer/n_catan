...
const OPTIONS=[
	...
	["Game","BotSpeed","bot_speed","Bot turn speed","option",["Relaxed","Normal","Fast"],"How long bots pause between actions. Their choices stay the same.",""],
	...
	["World","DayNightCycle","day_night_cycle","Day/night cycle","toggle",[],"Turn off to keep the island in daylight. Only your screen changes.","Negligible"],
	["World","Weather","weather","Weather","option",["Automatic","Clear skies","Cloudy","Rain","Thunderstorm"],"Choose changing weather or keep one condition. Rain and thunder have their own volume under Audio. Reduced motion disables rain and lightning flashes.","Moderate GPU impact"],
	...
	["Accessibility","ReducedMotion","reduce_motion","Reduced motion","toggle",[],"Stops wind, waves, scenery movement, particles and building animations. Gameplay is unchanged.",""],
	["Accessibility","LargeText","large_text","Larger small text","toggle",[],"Small labels render at 16 px instead of 14 px. Menus scroll when they run out of room.",""],
	["Display","Fullscreen","fullscreen","Fullscreen","toggle",[],"Fill the current display. Window size is used only in windowed mode.",""],
	["Display","WindowSize","window_size","Window size","option",["1280 × 720","1440 × 900","1920 × 1080","2560 × 1440","3840 × 2160"],"Size of the game window. Fullscreen uses your desktop resolution; render scale controls 3D resolution independently.","Larger sizes cost more GPU"],
	...
	["Display","FrameLimit","frame_limit","Frame limit","option",["Unlimited","30 FPS","60 FPS","90 FPS","120 FPS","144 FPS","240 FPS"],"Limit rendering to reduce GPU load and power use. Does not change game rules or bot speed.",""],
	...
	["Display","Upscaling","upscaling","Upscaling filter","option",["Bilinear","AMD FSR 1.0"],"FSR sharpens the world when rendering below 100%. It is spatial upscaling, without frame generation.","Low GPU impact"],
	...
	["Graphics","Quality","quality","Graphics preset","option",["Low","Medium","High","Ultra","Custom"],"Sets models, textures, lighting, water and anti-aliasing together. Changing one of them switches this to Custom. Display and audio settings stay as they are.","Ultra has a high GPU cost"],
	["Graphics","ModelQuality","model_quality","Model detail","option",["Low","Medium","High","Ultra"],"Adjust terrain tessellation, mesh level-of-detail bias and small scene details. Large landmarks and gameplay pieces stay visible at every level.","Geometry cost on CPU and GPU"],
	["Graphics","TextureQuality","texture_quality","Texture resolution","option",["Low · 512 px","Medium · 1024 px","High · 2048 px"],"The resolution of the terrain, stone and wood textures. Higher settings keep detail when you zoom in.","Uses more video memory"],
	...
	["Lighting","Exposure","exposure","Exposure","slider",[60,150,5,100],"Brightens or darkens the 3D scene. The interface stays the same.","Negligible"],
	...
	["Audio","WeatherVolume","weather_volume","Rain and thunder","slider",[0,100,1,100],"Volume of rain and thunder. Drizzle stays soft and muffled; only a downpour plays at full level.",""]]
