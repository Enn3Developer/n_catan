...
extends RefCounted
const LESSONS=[
	{"title":"Welcome to your first island","body":"Reach 10 victory points by building settlements and cities. Resources come from the land around them. Each lesson has you try one action, and later lessons start on a fresh practice board.","action":""},
	...
	{"title":"Roll for resources","body":"Click Roll dice. This practice roll will produce resources beside one of your settlements. A settlement collects 1 resource, a city 2. Everyone collects on every player's roll, not just their own turn.","action":"roll"},
	...
	{"title":"Trade for what you need","body":"Click Trade and swap with the bank. Usually 4 of one resource buys 1 of another. A 3:1 harbor improves every trade; a 2:1 harbor improves its pictured resource. In a real game you can also offer a trade to other players.","action":"bank_trade"},
	...
	{"title":"Play a development card","body":"Click the Knight card beside the action bar to play it. Knights move the robber and count toward the largest army. Other cards give roads, resources, a monopoly or hidden points. A card bought this turn waits for your next one, and you can play one card per turn.","action":"play_card"},
	{"title":"How to win","body":"Settlements give 1 point; cities give 2. The longest continuous road (at least 5) and largest army (at least 3 knights) give 2 each. Hidden point cards also count. Reach 10 on your turn to win. End turn when you finish building and trading.","action":""},
	{"title":"Your first real game","body":"Easy bots play gently. Normal bots build with a plan. Hard bots aim for a spread of resources and expand. You can mix levels in the lobby, and the guide is one click away in every game.","action":""}
]
var step=0
var completed=false
